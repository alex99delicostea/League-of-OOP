...
public class DarkAngel extends Angel {
    private final  int pyroModifier = 30;
    private final  int knightModifier = 40;
    private final  int rogueModifier = 10;
    private final  int wizardModifier = 20;
    public DarkAngel(final Pair<Integer, Integer> angelCoordonates, final String name) {
        super(angelCoordonates, name);
    }
    /**mesajul care apare cand DarkAngel ataca un jucator.*/
